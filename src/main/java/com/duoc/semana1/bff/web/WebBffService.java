...
public class WebBffService {
    ...
    private List<WebInteresResponse> mapearIntereses(
        ...
        return cuentas.stream()
                .map(cuenta -> {
                    WebInteresResponse response =
                            new WebInteresResponse();
    ...
    private List<WebMovimientoResponse> mapearMovimientos(
        ...
        return movimientos.stream()
                .map(movimiento -> {
                    WebMovimientoResponse response =
                            new WebMovimientoResponse();
    ...
    private List<WebTransaccionResponse> mapearTransacciones(
        ...
        return transacciones.stream()
                .map(transaccion -> {
                    WebTransaccionResponse response =
                            new WebTransaccionResponse();
